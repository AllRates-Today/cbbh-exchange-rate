# Central Bank of Bosnia and Herzegovina Exchange Rate API — cbbh-exchange-rate
...
Also published under the org scope as [`@allratestoday/cbbh-exchange-rate`](https://www.npmjs.com/package/@allratestoday/cbbh-exchange-rate) — same code, same versions.
