// Central Bank of Bosnia and Herzegovina exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/cbbh';
...
/** Latest rate for one pair, e.g. getRate('EUR', 'BAM', { apiKey }). */
